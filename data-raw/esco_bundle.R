...
esco_bundle <- lapply(esco_occupations_files, function(x){
  fread(
    "data-raw/esco_bundle_occupations_1.0.3//occupations_ar.csv",
...
usethis::use_data(occupations_bundle, overwrite = TRUE)
